...
#ifndef NOWTHISONEPLEASE_BINARYSEARCHTREES_H
#define NOWTHISONEPLEASE_BINARYSEARCHTREES_H
...
public:
    ...
    Node* findParent(DataType val);
    int depthHelper(Node* tree) const;
    void removeNode(Node* node);
};

#endif //NOWTHISONEPLEASE_BINARYSEARCHTREES_H
